...
export default function Test() {
  return (
    <div className="container relative mx-auto mt-16 bg-gray-200 rounded-md py-20 px-3 grid flex-col-reverse grid-cols-1 md:grid-cols-2 justify-center items-center">
