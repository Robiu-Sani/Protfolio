...
export default function Banner() {
  return (
    <div className="container reloadanimations mb-10 relative mx-auto mt-16 bg-gray-200 rounded-md py-20 px-3 grid flex-col-reverse grid-cols-1 gap-8 md:grid-cols-2 justify-center items-center">
      <div className="flex animationTimeline z-10 w-full flex-col gap-2 justify-center items-center md:items-start">
        <div className="text-center animationTimeline md:text-left px-4 md:px-10 ">
          ...
          <h2 className="text-gray-500 animationTimeline text-2xl md:text-3xl font-semibold mt-2">
            Full Stack Web Developer.
          </h2>
        </div>
        <div className="w-full z-10 animationTimeline px-2 md:pl-4 ml-0 md:ml-10 py-2 mt-4 relative border-0 md:border-l-2 border-gray-500">
          <p className="z-10">
        ...
        <div className=" flex flex-wrap justify-center md:justify-start pl-3 md:pl-12 w-full items-center gap-5 mt-5">
          <div className="overflow-hidden  animationTimeline shadow-md rounded-md">
            <Button
              path={"/resume"}
          ...
          <Link
            to="/contact"
            className="px-5 animationTimeline  py-1 border bg-white flex justify-center items-center gap-5 rounded-md shadow-md"
          >
      ...
      <div className="flex z-10 animationTimeline flex-col justify-center relative items-center gap-5">
        <img
          src={image}
          alt="banner image"
      ...
      <div className="absolute z-10 animationTimeline right-5 bottom-5 flex justify-center items-center gap-3">
        <a
