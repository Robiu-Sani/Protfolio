  ...
  return (
    <div className="w-full animationTimeline grid grid-cols-1 sm:grid-cols-2 p-6 space-y-8">
      ...
      <div className="bg-white animationTimeline shadow-lg rounded-lg p-4">
        <div className="flex animationTimeline items-center space-x-4">
          <FaHome size={30} className="text-blue-600 animationTimeline" />
          <div>
            <h3 className="text-xl animationTimeline font-bold">
              Present Address
            </h3>
            <p className="animationTimeline">
        ...
        <div className="mt-4 animationTimeline h-64">
          <MapContainer
            center={presentAddressCoords}
            zoom={12}
            className="h-full w-full animationTimeline rounded-lg"
          >
            <TileLayer
      ...
      <div className="bg-white animationTimeline shadow-lg rounded-lg p-4">
        <div className="flex items-center animationTimeline space-x-4">
          <FaMapMarkerAlt
            size={30}
            className="text-green-600 animationTimeline"
          />
          <div>
            <h3 className="text-xl animationTimeline font-bold">
              Permanent Address
